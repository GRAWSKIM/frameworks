	...
	<div class="container">
		...
		<button  class="btn btn-primary btn-lg">수정</button>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="inputPassword" name="name" value="${bean.name }">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword" class="col-sm-2 control-label">sabun</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="inputPassword" name="sabun" value="${bean.sabun }" readonly>
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword" class="col-sm-2 control-label">pay</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="inputPassword" name="pay" value="${bean.pay }">
		    </div>
		  </div>
